    ...
    const setStatusSenser = (senserId, status) => {
        ...
        setOptionData(prevOptionData => {
            ...
            if (getSocket().connected && setupPage) {
                ...
                getSocket().publish({
                    destination: '/app/relay-state',
                    body: JSON.stringify(relayAction)
                });
                console.log("success...")
            }
            return newOptionData;
                        ...
                        <div className='item-controller'>
                            <div className='inf-sensor'>
                                <div className='btn-controller'>
                                    <label class="toggle">
                                        <input type="checkbox" checked={optionData[0].isOn} onClick={() => handleClick('.on/off')} />
